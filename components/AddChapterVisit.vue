...
async function save() {
    ...
    visible.value = false;
    try {
        await useVisitsStore().postChapterVisit([props.chapterId], date.value.toISOString(), null, comment.value);
        toast.add({
            severity: 'success',
            summary: 'Success',
...
<template>
    ...
    <div class="card flex justify-content-center">
        ...
        <Dialog v-model:visible="visible" modal header="Add Visit" :style="{ width: '25rem' }">
            ...
            <span class="p-text-secondary block mb-5">Add a chapter visit.</span>
